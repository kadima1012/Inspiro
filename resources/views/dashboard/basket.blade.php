        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if ($orders->isEmpty())
                        <p>{{ __("You don't have any artwork in your basket at the moment.") }}</p>
                    @else
                                ...
                                <div class="grid grid-cols-5 gap-4 mt-4">
                                    @foreach ($order->artworks as $artwork)
                                        <div class="border border-gray-200 p-4 rounded-lg artwork-container">
                                            ...
                                            <form action="{{ route('cancel.add.to.basket') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="idArt" id="idArt" value="{{$artwork->idArt}}">

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('user.shop', ['username'=>$user->user_username]) }}" class="px-4 py-2 bg-red-600 text-white rounded">
                        All
                    </a>
                    @foreach($artworkTypes as $type)
                        <a href="{{ route('user.shop', ['type' => $type->idArtworkType, 'username'=>$user->user_username]) }}" class="px-4 py-2 bg-red-600 text-white rounded">
                            {{ $type->type_name }}
                        </a>
                    @endforeach
                </div>
